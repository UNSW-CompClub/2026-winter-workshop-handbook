...
> E.g., if you switch from Haiku to Fable, you'll only get 100,000 tokens instead of 1,000,000 out of $5 of credit, so spend wisely!
...
Once you've acquired your token, all you have to do is go into the `.env` file in your codebase, and add your token here!
```
